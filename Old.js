...
itemSelect.addEventListener("input",function() {
    ...
    const totalPrice =
        item.type === "kg"
            ...
            : item.price * quantity;
            const formattedTotalPrice1 = Number(totalPrice).toLocaleString()
            if (formattedTotalPrice1 === "NaN") {
                TotalPriceLabel.textContent = "Total: 0"
                return
            }
            TotalPriceLabel.textContent = "Total: "+formattedTotalPrice1
        });
